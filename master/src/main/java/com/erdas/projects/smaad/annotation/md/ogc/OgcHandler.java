...
public class OgcHandler extends BaseMetadataHandler {
	...
	public final static String WCS_CAPABILITIES	= "WCS_CAP_1.1.1";
	...
	final static String[] SUPPORTED_TYPES	= { WMS_CAPABILITIES, WCS_CAPABILITIES, WMC }; 

	
	// Namespaces
	
	final static String OGC_CONTEXT_NS			= "http://www.opengeospatial.net/context";
	final static String OGC_WCS_NS				= "http://www.opengis.net/wcs/1.1.1";
	final static String OGC_WMS_NS				= "http://www.opengis.net/wms";
	final static String OGC_OWS_NS				= "http://www.opengis.net/ows/1.1";
	...
	final static String WCS_CAPABILITIES_TAG		= "Capabilities";
	final static String SERVICE_IDENTIFICATION_TAG	= "ServiceIdentification";
	final static String KEYWORDS_TAG				= "Keywords";
	...
	public void addConcept(Document doc, List<Concept> conceptList)
		...
		} else if (WCS_CAPABILITIES.equals(type)) {
	...
	protected void addConceptToWcs(Document doc, List<Concept> conceptList) throws BadOgcDocumentException {
	...
	public String getType(Document doc) {
		...
		if (OGC_WCS_NS.equals(root.getNamespaceURI()) &&
				WCS_CAPABILITIES_TAG.equals(root.getLocalName())) {
			type = WCS_CAPABILITIES;
	...
	public String getMimeType(String type) {
		...
		if (WMS_CAPABILITIES.equals(type) || WCS_CAPABILITIES.equals(type)) {
